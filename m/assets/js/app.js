                          ...
                          $(".be-toggle-left-sidebar").on("click", function () {
                              t.hasClass(v.collapsibleSidebarCollapsedClass)
                                  ? (t.removeClass(v.collapsibleSidebarCollapsedClass),
                                    ...
                                    S(u),
                                    void 0 !== p && S(p))
                                  : (t.addClass(v.collapsibleSidebarCollapsedClass), $("li.active", o).parents(".parent").removeClass("open"), $("li.open", o).removeClass("open"), o.trigger("hidden.left-sidebar.collapse"));
                          }),
                          (function () {
...
(FastClick.prototype.needsClick = function (e) {
    ...
    (FastClick.prototype.onTouchStart = function (e) {
        ...
        return (
            (this.trackingClick = !0), (this.trackingClickStart = e.timeStamp), (this.targetElement = t), (this.touchStartX = i.pageX), (this.touchStartY = i.pageY), e.timeStamp - this.lastClickTime < this.tapDelay && e.preventDefault(), !0
        );
    }),
    ...
    (FastClick.prototype.onTouchEnd = function (e) {
        ...
        if (
            ...
            (this.trackingClick = !1),
            (this.trackingClickStart = 0),
            deviceIsIOSWithBadTarget && ((a = e.changedTouches[0]), ((r = document.elementFromPoint(a.pageX - window.pageXOffset, a.pageY - window.pageYOffset) || r).fastClickScrollParent = this.targetElement.fastClickScrollParent)),
                                ...
                                if (!(!0 === Ce.data(A + "_intouch") || e(t.target).closest(T.excludedElements, Ce).length > 0)) {
                                    ...
                                    if (!r.pointerType || "mouse" != r.pointerType || 0 != T.fallbackToMouseEvents) {
                                        ...
                                        return (
                                            ...
                                            V(),
                                            Z(0, c),
                                            !s || Se === T.fingers || T.fingers === b || Y() ? ((Ae = ae()), 2 == Se && (Z(1, s[1]), (me = be = oe(xe[0].start, xe[1].start))), (T.swipeStatus || T.pinchStatus) && (l = D(r, $e))) : (l = !1),
                                            !1 === l
                                                ? (D(r, ($e = C)), l)
                                                : (T.hold &&
                                                      (Be = setTimeout(
        ...
        (t.prototype = {
            ...
            getLuminance: function () {
                ...
                return (
                    ...
                    (i = n.g / 255),
                    (o = n.b / 255),
                    0.2126 * (0.03928 >= t ? t / 12.92 : e.pow((t + 0.055) / 1.055, 2.4)) + 0.7152 * (0.03928 >= i ? i / 12.92 : e.pow((i + 0.055) / 1.055, 2.4)) + 0.0722 * (0.03928 >= o ? o / 12.92 : e.pow((o + 0.055) / 1.055, 2.4))
                );
            },
            setAlpha: function (e) {
        ...
        return (
            (App.ChartJs = function () {
                ...
                (e = tinycolor(App.color.primary)),
                    ...
                    new Chart(b, { type: "polarArea", data: { datasets: [{ data: [11, 16, 7, 3, 14], backgroundColor: [g, h, f, m, p], label: "My dataset" }], labels: ["Red", "Green", "Yellow", "Grey", "Blue"] } }),
                    (v = App.color.primary),
                ...
                (i = tinycolor(App.color.primary).lighten(5).toString()),
                    ...
                    $.plot(
                        ...
                        ],
                        {
                            ...
                            legend: { show: !1 },
                            grid: { margin: { left: 23, right: 30, top: 20, botttom: 40 }, labelMargin: 10, axisMargin: 200, hoverable: !0, clickable: !0, tickColor: "rgba(0,0,0,0.15)", borderWidth: 1, borderColor: "rgba(0,0,0,0.15)" },
                            tooltip: {
                                show: !0,
                                cssClass: "tooltip-chart",
                                content: "<div class='content-chart'> <span> %s </span> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>",
                    ...
                    $.plot(
                        ...
                        ],
                        {
                            ...
                            tooltip: { show: !0, cssClass: "tooltip-chart", content: "<div class='content-chart'> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>", defaultTheme: !1 },
                            colors: [a],
                            xaxis: { ticks: 11, tickDecimals: 0 },
                    ...
                    (function () {
                        ...
                        var a = 500,
                            r = $.plot("#live-data", [n()], {
                                ...
                                grid: { show: !0, margin: { top: 3, bottom: 0, left: 0, right: 0 }, labelMargin: 0, axisMargin: 0, hoverable: !0, clickable: !0, tickColor: "rgba(0,0,0,0)", borderWidth: 0, minBorderMargin: 0 },
                                tooltip: {
                                    show: !0,
                                    cssClass: "tooltip-chart",
                    ...
                    $.plot(
                        ...
                        {
                            series: { lines: { show: !0, lineWidth: 1.5, fill: !0, fillColor: { colors: [{ opacity: 0.5 }, { opacity: 0.5 }] } }, fillColor: "rgba(0, 0, 0, 1)", points: { show: !1, fill: !0 }, shadowSize: 0 },
                            legend: { show: !1 },
                            grid: { show: !1, margin: { top: -20, bottom: 0, left: 0, right: 0 }, labelMargin: 0, axisMargin: 0, hoverable: !0, clickable: !0, tickColor: "rgba(0,0,0,0)", borderWidth: 0, minBorderMargin: 0 },
                            tooltip: {
                                show: !0,
                                cssClass: "tooltip-chart",
                                content: "<div class='content-chart'> <span> %s </span> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>",
                    ...
                    $.plot(
                        ...
                        {
                            series: { lines: { show: !0, lineWidth: 2, fill: !0, fillColor: { colors: [{ opacity: 0.35 }, { opacity: 0.35 }] } }, fillColor: "rgba(0, 0, 0, 1)", points: { show: !0, fill: !0, fillColor: v }, shadowSize: 0 },
                            legend: { show: !1 },
                ...
                $('[data-toggle="counter"]').each(function (e, t) {
                    ...
                    $.plot(
                        ...
                        ],
                        {
                            ...
                            legend: { show: !1 },
                            grid: { show: !0, margin: { top: 20, bottom: 0, left: 0, right: 0 }, labelMargin: 0, minBorderMargin: 0, axisMargin: 0, tickColor: "rgba(0,0,0,0.05)", borderWidth: 0, hoverable: !0, clickable: !0 },
                            tooltip: {
                                show: !0,
                                cssClass: "tooltip-chart",
                                content: "<div class='content-chart'> <span> %s </span> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>",
        ...
        return (
            (App.tableFilters = function () {
                $(".select2").select2({ width: "100%" }),
                    $(".tags").select2({ tags: !0, width: "100%" }),
                    $(".bslider").bootstrapSlider(),
                    $(".datetimepicker").datetimepicker({ autoclose: !0, componentIcon: ".mdi.mdi-calendar", format: "mm/dd/yyyy", navIcons: { rightIcon: "mdi mdi-chevron-right", leftIcon: "mdi mdi-chevron-left" } }),
        ...
        return (
            (App.dataTables = function () {
                ($.fn.DataTable.ext.pager.numbers_length = 4),
                    $.extend(!0, $.fn.dataTable.defaults, { dom: "<'row be-datatable-header'<'col-sm-6'l><'col-sm-6'f>><'row be-datatable-body'<'col-sm-12'tr>><'row be-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>" }),
                    $("#table1").dataTable(),
            ...
            (App.uiNotifications = function () {
                $("#not-basic").click(function () {
                    ...
                    $("#not-text").click(function () {
                        return $.gritter.add({ title: "Just Text", text: "This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum.", class_name: "clean", time: "" }), !1;
                    }),
                    ...
                    $("#not-facebook").click(function () {
                        return (
                            $.gritter.add({ title: "You have comments!", text: "You can start your day checking the new messages.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/fb-icon.png", class_name: "color facebook" }), !1
                        );
                    }),
                    $("#not-twitter").click(function () {
                        return (
                            $.gritter.add({ title: "You have new followers!", text: "You can start your day checking the new messages.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/tw-icon.png", class_name: "color twitter" }),
                            !1
                        );
                    }),
                    $("#not-google-plus").click(function () {
                        return (
                            $.gritter.add({ title: "You have new +1!", text: "You can start your day checking the new messages.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/gp-icon.png", class_name: "color google-plus" }), !1
                        );
                    }),
                    $("#not-dribbble").click(function () {
                        return (
                            $.gritter.add({ title: "You have new comments!", text: "You can start your day checking the new comments.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/db-icon.png", class_name: "color dribbble" }),
                            !1
                        );
                    }),
                    $("#not-flickr").click(function () {
                        return (
                            $.gritter.add({ title: "You have new comments!", text: "You can start your day checking the new comments.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/fl-icon.png", class_name: "color flickr" }), !1
                        );
                    }),
                    $("#not-linkedin").click(function () {
                        return (
                            $.gritter.add({ title: "You have new comments!", text: "You can start your day checking the new comments.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/in-icon.png", class_name: "color linkedin" }),
                            !1
                        );
                    }),
                    $("#not-youtube").click(function () {
                        return (
                            $.gritter.add({ title: "You have new comments!", text: "You can start your day checking the new comments.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/yt-icon.png", class_name: "color youtube" }), !1
                        );
                    }),
                    $("#not-pinterest").click(function () {
                        return (
                            $.gritter.add({ title: "You have new comments!", text: "You can start your day checking the new comments.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/pi-icon.png", class_name: "color pinterest" }),
                            !1
                        );
                    }),
                    $("#not-github").click(function () {
                        return $.gritter.add({ title: "You have new forks!", text: "You can start your day checking the new comments.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/gh-icon.png", class_name: "color github" }), !1;
                    }),
                    $("#not-tumblr").click(function () {
                        return (
                            $.gritter.add({ title: "You have new comments!", text: "You can start your day checking the new comments.", image: App.conf.assetsPath + "/" + App.conf.imgPath + "/tu-icon.png", class_name: "color tumblr" }), !1
                        );
                    }),
            ...
            (App.uiSweetalert2 = function () {
                (Swal = Swal.mixin({ confirmButtonClass: "btn btn-primary", cancelButtonClass: "btn btn-secondary", buttonsStyling: !1 })),
                    ...
                    $("#swal-title").click(function () {
                        return Swal.fire({ title: "Sweetalert example", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ultrices euismod lobortis.", confirmButtonText: "Proceed", showCloseButton: !0 }), !1;
                    }),
                    ...
                    $("#swal-queue").click(function () {
                        return (
                            Swal.mixin({ input: "text", confirmButtonText: "Next &rarr;", showCancelButton: !0, customClass: "content-header-center content-header-title-left content-actions-left", progressSteps: ["1", "2", "3"] })
                    ...
                    $("#swal-image").click(function () {
                        return Swal.fire({ title: "Sweet!", text: "Modal with a custom image.", confirmButtonText: "Proceed", imageUrl: "https://unsplash.it/400/200", imageWidth: 400, imageHeight: 200, imageAlt: "Custom image" }), !1;
                    }),
                    ...
                    $("#swal-select").click(function () {
                        return (
                            Swal.fire({ title: "Select country", confirmButtonText: "Proceed", input: "select", inputOptions: { SRB: "Serbia", UKR: "Ukraine", HRV: "Croatia" }, inputPlaceholder: "Select country", showCancelButton: !0 }), !1
                        );
                    }),
